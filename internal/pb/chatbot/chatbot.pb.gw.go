...
/*
Package chatbot is a reverse proxy.
...
func request_ChatService_RespondToUserQuery_0(ctx context.Context, marshaler runtime.Marshaler, client ChatServiceClient, req *http.Request, pathParams map[string]string) (ChatService_RespondToUserQueryClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.RespondToUserQuery(ctx, &protoReq)
	if err != nil {
...
func RegisterChatServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ChatServiceServer) error {
	...
	mux.Handle("POST", pattern_ChatService_RespondToUserQuery_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterChatServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ChatServiceClient) error {
	...
	mux.Handle("POST", pattern_ChatService_RespondToUserQuery_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ChatService_RespondToUserQuery_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		...
		forward_ChatService_RespondToUserQuery_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	forward_ChatService_RespondToUserQuery_0 = runtime.ForwardResponseStream
)
